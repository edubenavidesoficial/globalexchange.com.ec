...
export function initHeader() {
    ...
    const programsMenu = header.querySelector('#programs-menu');
    ...
    function closeDropdowns() {
        ...
        programsMenu?.setAttribute('inert', '');
    ...
    dropdownToggles.forEach((toggle) => {
        toggle.addEventListener('click', (event) => {
            ...
            if (willOpen) {
                ...
                if (programsMenu && menuItem.classList.contains('header__programs')) {
                    programsMenu.removeAttribute('inert');
                }
            }
        });
    });
